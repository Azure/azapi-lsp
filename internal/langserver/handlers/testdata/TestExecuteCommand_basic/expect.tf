...
terraform import azapi_resource.managedCluster /subscriptions/0000000/resourcegroups/acctestRG-aks-240626160102776968/providers/Microsoft.ContainerService/managedClusters/acctestaks240626160102776968?api-version=2024-07-01

Or add the below config:
import {
  id = "/subscriptions/0000000/resourcegroups/acctestRG-aks-240626160102776968/providers/Microsoft.ContainerService/managedClusters/acctestaks240626160102776968?api-version=2024-07-01"
  to = azapi_resource.managedCluster
}
*/

resource "azapi_resource" "managedCluster" {
  type      = "Microsoft.ContainerService/managedClusters@2024-07-01"
